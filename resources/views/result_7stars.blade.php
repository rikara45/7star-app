    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border-t-8 border-yellow-400 relative mb-8">
                ...
                </div> <div class="bg-white p-4 border-t border-gray-200 flex justify-center items-center">
                    <a href="{{ route('result.pdf') }}" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-6 rounded-lg shadow-md flex items-center transition transform hover:-translate-y-0.5">
