            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border-t-8 border-teal-400 relative mb-8">
                ...
                <div class="p-8 text-center">
                    ...
                    <div class="my-6">
                        ...
                        <div class="flex justify-center mt-2 space-x-1 text-yellow-400 text-4xl">
                            @php $starCount = (int) filter_var($analysis->star_rating, FILTER_SANITIZE_NUMBER_INT); @endphp
                            @for($i=1; $i<=7; $i++)
                                @if($i <= $starCount) <span>★</span> @else <span class="text-gray-200">★</span> @endif
                            @endfor
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 border-t border-gray-200 bg-gray-50">
                    ...
                    <div class="p-6 text-center border-b md:border-b-0 md:border-r border-gray-200 relative group">
                        ...
                        <span class="block text-4xl font-extrabold text-blue-600 mb-1">{{ number_format($analysis->score_behavior, 1) }}</span>
                    ...
                    <div class="p-6 text-center flex flex-col justify-center">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('jurusan.verifikasi.show', $dosen->id) }}" class="text-xs font-bold text-green-600 hover:underline flex justify-center items-center">
                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                Cek Bukti Portofolio
                            </a>
                        </div>
                    </div>
                </div>

                <div class="bg-white p-4 border-t border-gray-200 flex justify-center items-center">
                    <a href="{{ route('jurusan.result.pdf', $dosen->id) }}" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-6 rounded-lg shadow-md flex items-center transition transform hover:-translate-y-0.5">
